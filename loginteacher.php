...
if(isset($_SESSION['SESS_FIRST_NAME'])&&isset($_SESSION['SESS_LAST_NAME'])) {
     header("Location:hometeacher.php"); // redirects them to homepage
...
<body>
<form action="login_execteacher.php" name="login" method="post">
<div class="imgcontainer"><img src="img_avatar2.png"  width="23%" class="avatar1111"/></div>
<div class="container">
<label><b>id:</b></label></br>

<label></label>
<input type="text" name="id" size=" "maxlength=" " placeholder="id" required/>
...
<?php
		   ...
		   echo '<div class="box">';
		   echo'<p>';
		   echo"password or id do not match";
		   echo'</p>';
		   echo'</div>';
...
<button type="button" style="width:200px; background-color:#EFD910"class="loginasstudent"><a href="login.php" style="text-decoration:none">login as student</a></button>
